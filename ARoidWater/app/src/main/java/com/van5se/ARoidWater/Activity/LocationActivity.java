...
import com.van5se.ARoidWater.service.Utils;
...
public class LocationActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startLocation = (Button) findViewById(R.id.button_start_locate);
    }
    ...
    protected void onStart() {
        ...
        startLocation.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (startLocation.getText().toString().equals(getString(R.string.start_locate))) {
                    locationService.start();// 定位SDK
                    // start之后会默认发起一次定位请求，开发者无须判断isstart并主动调用request
                    startLocation.setText(getString(R.string.stop_locate));
                } else {
                    locationService.stop();
                    startLocation.setText(getString(R.string.start_locate));
                }
            }
        });
    }
